                        ...
                        <div class="col">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div
                                        class="col-12 col-lg-1 d-flex align-items-center mb-2 mb-lg-0 text-muted text-small">
                                        ID
                                    </div>
                                    <div
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">245</a>
                                </div>
                                <div
                  ...
                  <span>
                    ...
                    321.75
                                ...
                                <div
                                    ...
                                    <div class="text-alternate">
                                        <a href="{{ url('/Orders/Detail') }}"
                                           class="text-truncate h-100 d-flex align-items-center">5323</a>
                                    </div>
                                </div>
                                <div
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">244</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">243</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">242</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">241</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                  ...
                  <span>
                    ...
                    29.30
                                ...
                                <div
                                    ...
                                    <div class="text-alternate">
                                        <a href="{{ url('/Orders/Detail') }}"
                                           class="text-truncate h-100 d-flex align-items-center">5321</a>
                                    </div>
                                </div>
                                <div
                                    class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">240</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                  ...
                  <span>
                    ...
                    462.20
                                ...
                                <div
                                    ...
                                    <div class="text-alternate">
                                        <a href="{{ url('/Orders/Detail') }}"
                                           class="text-truncate h-100 d-flex align-items-center">5320</a>
                                    </div>
                                </div>
                                <div
                                    class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">239</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">238</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                  ...
                  <span>
                    ...
                    85.20
                                ...
                                <div
                                    ...
                                    <div class="text-alternate">
                                        <a href="{{ url('/Orders/Detail') }}"
                                           class="text-truncate h-100 d-flex align-items-center">5318</a>
                                    </div>
                                </div>
                                <div
                                    class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">237</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                  ...
                  <span>
                    ...
                    104.65
                                ...
                                <div
                                    ...
                                    <div class="text-alternate">
                                        <a href="{{ url('/Orders/Detail') }}"
                                           class="text-truncate h-100 d-flex align-items-center">5317</a>
                                    </div>
                                </div>
                                <div
                                    class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
                        ...
                        <div class="card-body pt-0 pb-0 sh-30 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none">Id</div>
                                    <a href="{{ url('/Customers/Detail') }}"
                                       class="text-truncate h-100 d-flex align-items-center">236</a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-2">
                                    <div class="text-muted text-small d-lg-none">Name</div>
                  ...
                  <span>
                    ...
                    72.50
                                ...
                                <div
                                    ...
                                    <div class="text-alternate">
                                        <a href="{{ url('/Orders/Detail') }}"
                                           class="text-truncate h-100 d-flex align-items-center">5316</a>
                                    </div>
                                </div>
                                <div
                                    class="col-12 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-last order-lg-5">
