...
@section('js_page')
    <script src="{{ asset('/js/pages/customers.detail.js') }}"></script>
@endsection
                        ...
                        <div class="mb-5">
                            <div class="row g-0 align-items-center mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="p mb-0 sh-5 d-flex align-items-center lh-1-25">Lifetime Spent
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="row g-0 align-items-center mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="p mb-0 sh-5 d-flex align-items-center lh-1-25">Avarage Order
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="row g-0 align-items-center mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="p mb-0 sh-5 d-flex align-items-center lh-1-25">Order Count</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="mb-5">
                            <div>
                                ...
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col text-alternate">4 Glamis Avenue, Strathmore Park, Wellington 6022,
                                        New Zealand
                                    </div>
                                </div>
                                <div class="row g-0 mb-2">
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div
                                            ...
                                            <div class="text-muted text-small d-md-none">Id</div>
                                            <a href="{{ url('/Orders/Detail') }}"
                                               class="text-truncate h-100 d-flex align-items-center">1251</a>
                                        </div>
                                        <div
                                            class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                            <div class="text-muted text-small d-md-none">Price</div>
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div
                                            ...
                                            <div class="text-muted text-small d-md-none">Id</div>
                                            <a href="{{ url('/Orders/Detail') }}"
                                               class="text-truncate h-100 d-flex align-items-center">1397</a>
                                        </div>
                                        <div
                                            class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                            <div class="text-muted text-small d-md-none">Price</div>
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div
                                            ...
                                            <div class="text-muted text-small d-md-none">Id</div>
                                            <a href="{{ url('/Orders/Detail') }}"
                                               class="text-truncate h-100 d-flex align-items-center">1421</a>
                                        </div>
                                        <div
                                            class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                            <div class="text-muted text-small d-md-none">Price</div>
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div
                                            ...
                                            <div class="text-muted text-small d-md-none">Id</div>
                                            <a href="{{ url('/Orders/Detail') }}"
                                               class="text-truncate h-100 d-flex align-items-center">1438</a>
                                        </div>
                                        <div
                                            class="col-6 col-md-4 d-flex flex-column justify-content-center mb-2 mb-md-0">
                                            <div class="text-muted text-small d-md-none">Price</div>
                                ...
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-muted mt-1">Dragée macaroon lemon drops icing cupcake
                                                gingerbread. Apple pie caramels tart.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-alternate">12.02.2021</div>
                                            <div class="text-muted mt-1">Marshmallow donut sweet roll. Wafer tootsie
                                                roll gingerbread croissant ice cream.
                                            </div>
                                        </div>
                                    </div>
                                </div>
