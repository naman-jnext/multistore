                                    ...
                                    <div class="row g-0 sh-10 mb-3">
                                        ...
                                        <div class="col">
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="mb-1">
                                                        <a href="/Products/Detail" class="body-link">Soda Bread</a>
                                                        <span class="text-muted">by</span>
                                                        <a href="/Customers/Detail" class="body-link">Kathleen
                                                            Bertha</a>
                                                    </div>
                                                    <div class="text-small text-muted text-truncate mb-1">
                                                        Chocolate bar marzipan marzipan carrot cake gingerbread pastry
                                                        ice cream. Ice cream danish sugar plum biscuit pudding powder
                                    ...
                                    <div class="row g-0 sh-10 mb-3">
                                        ...
                                        <div class="col">
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="mb-1">
                                                        <a href="/Products/Detail" class="body-link">Barmbrack</a>
                                                        <span class="text-muted">by</span>
                                                        <a href="/Customers/Detail" class="body-link">Kathleen
                                                            Bertha</a>
                                                    </div>
                                                    <div class="text-small text-muted text-truncate mb-1">Bear claw
                                                        sweet liquorice jujubes. Muffin gingerbread bear claw.
                                                    </div>
                                                    <div class="br-wrapper br-theme-cs-icon">
                                                        <select class="rating" name="rating" autocomplete="off"
                                                                data-readonly="true" data-initial-rating="5">
                                    ...
                                    <div class="row g-0 sh-10 mb-3">
                                        ...
                                        <div class="col">
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="mb-1">
                                                        <a href="/Products/Detail" class="body-link">Fougasse</a>
                                                        <span class="text-muted">by</span>
                                                        <a href="/Customers/Detail" class="body-link">Olli
                                                            Hawkins</a>
                                                    </div>
                                                    <div class="text-small text-muted text-truncate mb-1">Bear claw
                                                        sweet liquorice jujubes. Muffin gingerbread bear claw.
                                    ...
                                    <div class="row g-0 sh-10">
                                        ...
                                        <div class="col">
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="mb-1">
                                                        <a href="/Products/Detail" class="body-link">Steirer
                                                            Brot</a>
                                                        <span class="text-muted">by</span>
                                                        <a href="/Customers/Detail" class="body-link">Zayn
                                                            Hammond</a>
                                                    </div>
                                                    <div class="text-small text-muted text-truncate mb-1">Chupa chups
                                                        candy canes.
                                                    </div>
                                                    <div class="br-wrapper br-theme-cs-icon">
                                                        <select class="rating" name="rating" autocomplete="off"
                                    ...
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            <div class="col-12 col-md-6 d-flex align-items-center mb-2 mb-md-0">
                                                <a href="/Products/Detail">Cholermüs</a>
                                            </div>
                                            <div
                            ...
                            <div class="row g-0 sh-14 sh-md-10">
                                ...
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            <div class="col-12 col-md-6 d-flex align-items-center mb-2 mb-md-0">
                                                <a href="/Products/Detail">Ruisreikäleipä</a>
                                            </div>
                                            <div
                                                class="col-12 col-md-3 d-flex align-items-center text-muted text-medium">
                                                Sourdough
                            ...
                            <div class="row g-0 sh-14 sh-md-10">
                                ...
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            <div class="col-12 col-md-6 d-flex align-items-center mb-2 mb-md-0">
                                                <a href="/Products/Detail">Barmbrack</a>
                                            </div>
                                            <div
                                                class="col-12 col-md-3 d-flex align-items-center text-muted text-medium">
                                                Whole Wheat
                            ...
                            <div class="row g-0 sh-14 sh-md-10">
                                ...
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            <div class="col-12 col-md-6 d-flex align-items-center mb-2 mb-md-0">
                                                <a href="/Products/Detail">Cheesymite Scroll</a>
                                            </div>
                                            <div
                                                class="col-12 col-md-3 d-flex align-items-center text-muted text-medium">
                                                Whole Wheat
                            ...
                            <div class="row g-0 sh-14 sh-md-10">
                                ...
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            <div class="col-12 col-md-6 d-flex align-items-center mb-2 mb-md-0">
                                                <a href="/Products/Detail">Buccellato di Lucca</a>
                                            </div>
                                            <div
                                                class="col-12 col-md-3 d-flex align-items-center text-muted text-medium">
                                                Whole Wheat
